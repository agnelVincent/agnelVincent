...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f2027,50:203a43,100:2c5364&height=200&section=header&text=Agnel%20Vincent&fontSize=50&fontColor=ffffff&fontAlignY=38&desc=Python%20Full%20Stack%20Developer&descSize=18&descAlignY=58&descColor=a8d8ea" width="100%"/>

</div>

<div align="center">

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=20&pause=1000&color=2C9FD9&center=true&vCenter=true&width=600&lines=Python+%7C+Django+%7C+React+Developer;Building+Scalable+Full-Stack+Apps;Real-Time+%26+REST+API+Specialist;Based+in+Thrissur%2C+Kerala+%F0%9F%8C%B4)](https://git.io/typing-svg)
...
| Domain | Skills |
|--------|--------|
| 🔗 **API Development** | REST APIs, Django REST Framework, Token Auth, JWT |
| ⚡ **Real-Time Apps** | Django Channels, WebSockets, Async Views |
| 🎨 **Frontend** | React, JavaScript, Responsive UI with HTML & CSS |
| 🗄️ **Databases** | PostgreSQL (with ORM), MongoDB |
| ☁️ **Deployment** | AWS EC2/S3, Nginx, Linux Server Setup |
| 🛠️ **Workflow** | Git, Postman, Figma, REST API Design |
